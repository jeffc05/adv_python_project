...
def create_filters(
    ...
    return date_filter, start_date_filter, end_date_filter,\
           distance_min_filter, distance_max_filter,\
           velocity_min_filter, velocity_max_filter,\
           diameter_min_filter, diameter_max_filter,\
           hazardous_filter
...
def limit(iterator, n=None):
    ...
    if n == 0 or n is None:
        ...
        for approach in islice(iterator, n):
            yield approach
